...
import Mesastodas from './pagar/ListaApagar';
...
const pedidoDocRef = doc(db, 'produtos', 'produtoId'); // Substitua 'pedidoId' pelo ID do pedido atual
  ...
  return (
    <div className="justify-center container mx-auto p-15">
      <Paper className={classes.root}>
        ...
        <Link href="/enterprises/varejo/caixa/produtos" passHref>
  <motion.button
