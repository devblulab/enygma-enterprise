    ...
    <div className={classes.menuWrapper}>
      ...
      >
        {[
          ...
          { href: '/beto/requerimento/digital', icon: <FaStore />, label: 'Intenção de Venda Digital' },
          { href: '/beto/dashboard/digital/empresas', icon: <FaChartPie />, label: 'Painel de Controle Empresas Digital' }
        ].map((item, index) => (
          <motion.div 
            key={index} 
