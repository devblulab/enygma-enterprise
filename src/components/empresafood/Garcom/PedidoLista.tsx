...
if (hideCompletedMesas && isMesaConcluida) {
    ...
    return (
      <div key={mesa}>
        ...
        <Typography variant="body1">Total Pedido: R$ {totalPedido.toFixed(2)}</Typography>
...
<Typography variant="h6">Mesa: {pedido.mesa}</Typography>
            <Typography variant="body1">Cliente: {pedido.cliente}</Typography>
            <Typography variant="body1">Total: R$ {pedido.total}</Typography>
            <Typography variant="body1">Status: {pedido.status}</Typography>
            <Typography variant="body1">Pedidos: {pedido.item.nome}</Typography>
